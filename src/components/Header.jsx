        ...
        <div className="bg-[var(--white-500)] text-[var(--black)] w-full h-16 px-6">
            <div className="flex justify-between items-center mt-2">
                <span className="flex-none">
                    <img src={logo} alt="ciné logo" className="w-12 h-12" /></span>
                ...
                <span className="flex-none"><img src={filmMain} alt="user image" className="w-12 h-12 border-1 border-solid rounded-full" /></span>
            </div>
        </div>
    )
}
